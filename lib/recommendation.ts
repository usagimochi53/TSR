...
const themeMessages: Record<WalkTheme, string> = {
  ...
  パン屋巡り:
    "焼きたての香りを探しながら、朝にも昼にも合う道を歩いてみましょう。",
  "神社・お寺巡り":
    "静かな場所を目指して、気持ちを整える散歩にしてみましょう。",
  "川沿い・水辺巡り":
    "水辺の風を感じられる道を探して、長めに歩いてみましょう。",
  商店街巡り:
    "小さなお店や路地を見つけながら、街歩きを楽しんでみましょう。",
  銭湯巡り:
    "歩いた後に汗を流せる銭湯を目指して、気持ちよく歩いてみましょう。",
  スーパー銭湯巡り:
    "温浴施設をゴールにして、歩いた後の休憩まで楽しんでみましょう。",
};
